...
export class Chat extends APIResource {
  ...
  createChatCompletion(
    params: ChatCreateChatCompletionParams,
    options?: RequestOptions,
  ): APIPromise<CreateChatCompletionResponse> {
    const { CreateChatCompletionRequest } = params;
    return this._client.post('/chat/completions', { body: CreateChatCompletionRequest, ...options });
  }
}
...
export interface ChatCompletionMessageToolCallChunk {
  ...
  function?: ChatCompletionMessageToolCallChunk.Function;
...
export interface ChatCompletionStreamResponseDelta {
   ...
   * function that should be called, as generated by the model.
   */
  function_call?: ChatCompletionStreamResponseDelta.FunctionCall;
...
export interface CreateChatCompletionRequest extends CreateModelResponseProperties {
   ...
   */
  audio?: CreateChatCompletionRequest.Audio | null;
   ...
   */
  web_search_options?: CreateChatCompletionRequest.WebSearchOptions;
}
...
export namespace CreateChatCompletionRequest {
  ...
  export interface WebSearchOptions {
     ...
     */
    search_context_size?: ChatAPI.WebSearchContextSize;
  ...
  export namespace WebSearchOptions {
    ...
    export interface UserLocation {
       ...
       * Approximate location parameters for the search.
       */
      approximate: ChatAPI.WebSearchLocation;
...
export interface CreateChatCompletionResponse {
   ...
   * than 1.
   */
  choices: Array<CreateChatCompletionResponse.Choice>;
...
export namespace CreateChatCompletionResponse {
  export interface Choice {
     ...
     * A chat completion message generated by the model.
     */
    message: ChatAPI.ChatCompletionResponseMessage;
  }
...
export interface CreateChatCompletionStreamResponse {
   ...
   */
  choices: Array<CreateChatCompletionStreamResponse.Choice>;
...
export namespace CreateChatCompletionStreamResponse {
  export interface Choice {
     ...
     * A chat completion delta generated by streamed model responses.
     */
    delta: ChatAPI.ChatCompletionStreamResponseDelta;
...
export interface CreateModelResponseProperties extends ModelResponseProperties {
  /**
   * An integer between 0 and 20 specifying the number of most likely tokens to
   * return at each token position, each with an associated log probability.
   */
...
export namespace ResponseFormatJsonSchema {
  ...
  export interface JsonSchema {
     ...
     */
    schema?: ChatAPI.ResponseFormatJsonSchemaSchema;
